...
# 音调定义
CL = [1, 131, 147, 165, 175, 196, 211, 248]  # 低C音阶的频率
CM = [1, 262, 294, 330, 350, 393, 441, 495]  # 中C音阶的频率
CH = [1, 525, 589, 661, 700, 786, 882, 990]  # 高C音阶的频率

# 第一首歌曲谱
makerobo_song_1  = [
    CL[0], CL[0], CM[5], CM[5], CM[6], CM[5], CH[1], CM[7], CM[5], CM[5], CM[6], CM[5], CH[2],
]
# 小星星的节拍，1表示1/4拍
makerobo_beat_1  = [
